<template>
  <div id="app">
    ...
    <xj-button @click="goProgressBarDemo">goProgressBar</xj-button>
    <xj-button @click="goSlideDemo">goSlide</xj-button>
...
export default {
  ...
  methods: {
    ...
    goProgressBarDemo () {
      this.$router.push('./ProgressBarDemo')
    },
    goSlideDemo () {
      this.$router.push('./SlideDemo')
    }
  },
  mounted () {
